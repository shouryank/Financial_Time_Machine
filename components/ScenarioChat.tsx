...
const ScenarioChat: React.FC<ScenarioChatProps> = ({ messages, onSendMessage, isProcessing }) => {
  ...
  return (
    <div className="glass rounded-2xl h-[550px] flex flex-col overflow-hidden border border-slate-700/50">
      <div className="p-4 border-b border-slate-700/50 bg-slate-900/40 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-sm tracking-tight">Temporal Architect</h3>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {isProcessing && (
          <div className="flex justify-start">
            <div className="bg-slate-800 text-slate-200 rounded-2xl rounded-tl-none p-4 border border-slate-700/50">
      ...
      <form onSubmit={handleSubmit} className="p-4 bg-slate-900/60 border-t border-slate-700/50">
